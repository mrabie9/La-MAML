        ...
        grid_factory=make_grid_factory(
            {
                ...
                "ctx_lr": {"kind": "float", "factors": (0.5, 1.0, 2.0), "min": 1e-4, "fallback": 0.05,
                             "values": [0.03,0.01,0.003,0.001]},#,0.0003,0.0001,0.00003,0.00001]},
                "task_emb": {"kind": "int", "factors": (0.5, 1.0, 2.0), "min": 16, "fallback": 64,
                            "values": [16, 32, 64, 128]},
        ...
        grid_factory=make_grid_factory(
            {
                ...
                "beta": {"kind": "float", "factors": (0.5, 1.0, 2.0), "min": 1e-5, "fallback": 2e-4,
                        "values":[0.0001,0.0002,0.001,0.002]},#[0.1,0.5,5,10,50,100]},
#                 "det_lambda": {"kind": "float", "factors": (0.5, 1.0, 2.0), "min": 0.1, "fallback": 1.0,
