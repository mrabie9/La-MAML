        ...
        grid_factory=make_grid_factory(
            {
                ...
                #     "values": [32, 64, 128, 256]},
                "lr": {"kind": "float", "factors": (0.3, 1.0, 3.0), "min": 1e-5, "fallback": 1e-3,
                       "values":[0.03,0.01,0.003,0.001,0.0003,0.0001,0.00003,0.00001]},#"values":[0.001]},
        ...
        grid_factory=make_grid_factory(
            {
                ...
                "lr": {"kind": "float", "factors": (0.5, 1.0, 2.0), "min": 1e-4, "fallback": 0.01,
                            "values":[0.03,0.01,0.003,0.001,0.0003,0.0001,0.00003,0.00001]},#"values":[0.003]},
        ...
        grid_factory=make_grid_factory(
            {
                ...
                #     "values": [32, 64, 128, 256]},
                "lr": {"kind": "float", "factors": (0.3, 1.0, 3.0), "min": 1e-5, "fallback": 1e-2,
                       "values":[0.03,0.01,0.003,0.001,0.0003,0.0001,0.00003,0.00001]},#"values":[0.01]},
        ...
        grid_factory=make_grid_factory(
            {
                ...
                #     "values": [32, 64, 128, 256]},
                "lr": {"kind": "float", "factors": (0.3, 1.0, 3.0), "min": 1e-5, "fallback": 1e-2,
                       "values": [0.001]}, #[0.03,0.01,0.003,0.001,0.0003,0.0001,0.00003,0.00001]},
#                 "det_lambda": {"kind": "float", "factors": (0.5, 1.0, 2.0), "min": 0.1, "fallback": 1.0,
#                             "values": [1,10,100,1000,10000]},
                # "memories": {"kind": "int", "factors": (0.5, 1.0, 2.0), "min": 100, "fallback": 400,
                #              "values": [1024, 2048, 5120]},
        ...
        grid_factory=make_grid_factory(
            {
                ...
                "lamb": {"kind": "float", "factors": (0.3, 1.0, 3.0), "min": 1e-2, "fallback": 1.0,
                         "values": [10000]}, #[1,10,100,1000,10000]},
#                 "det_lambda": {"kind": "float", "factors": (0.5, 1.0, 2.0), "min": 0.1, "fallback": 1.0,
#                                 "values": [1,10,100,1000,10000]},
            }
        ),
        ...
        grid_factory=make_grid_factory(
            {
                ...
                #     "values": [32, 64, 128, 256]},
                "lr": {"kind": "float", "factors": (0.3, 1.0, 3.0), "min": 1e-5, "fallback": 1e-2,
                       "values":[0.03,0.01,0.003,0.001,0.0003,0.0001,0.00003,0.00001]},#"values":[0.03]},
        ...
        grid_factory=make_grid_factory(
            {
                ...
                #     "values": [32, 64, 128, 256]},
                "lr": {"kind": "float", "factors": (0.3, 1.0, 3.0), "min": 1e-5, "fallback": 1e-2,
                       "values":[0.001]}, #[0.03,0.01,0.003,0.001,0.0003,0.0001,0.00003,0.00001]},#"values":[0.01]},
                "memory_strength": {"kind": "float", "factors": (0.5, 1.0, 2.0), "min": 0.1, "fallback": 0.5,
                        "values":[10,30, 100, 300, 1000, 3000]},
#                 "det_lambda": {"kind": "float", "factors": (0.5, 1.0, 2.0), "min": 0.1, "fallback": 1.0,
#                         "values": [10,30, 100, 300, 1000, 3000]},
